"""
Django settings for AfyaMum_Bot project.
...
SECRET_KEY = 'django-insecure-4==gd&7r(yhmshc2_nve$4np=7x7ob*gamta+bx@pkp3c)^t4i'
...
WSGI_APPLICATION = 'AfyaMum_Bot.wsgi.application'
